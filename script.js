...
function openReviewDetail(id) {
    ...
    modal.innerHTML = `
        <div class="review-detail-card" style="border-top: 4px solid ${accentColor}">
            ...
            <div class="detail-content">
                ...
                <div class="detail-left">
                    ...
                    <div style="background:rgba(0,0,0,0.6); padding:10px; border-radius:8px; border:1px solid rgba(255,255,255,0.1); text-align:center;">
                        <div style="display:flex; justify-content:center; gap:5px; margin-bottom:5px;">
                            ${renderStars(item.rating, accentColor)}
                        </div>
                        <span style="font-family:'Rajdhani'; font-size:1.2rem; font-weight:bold; color:${accentColor}">
                            ${item.rating} / 5
                        </span>
                    </div>
                </div>
                ...
                <div class="detail-right">
                    <div class="detail-header">
                        <h1 style="color:${accentColor}">${item.titolo}</h1>
                    </div>

                    <div class="detail-meta-badges">
                        <span class="meta-badge" style="border-color:${accentColor}; color:${accentColor}">${item.categoria}</span>
