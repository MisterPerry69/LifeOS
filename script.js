...
function openReviewDetail(id) {
    ...
    modal.innerHTML = `
        <div class="review-detail-card" style="border-top: 3px solid ${color}">
            <i data-lucide="circle-x" style="position: absolute; top: 20px; right: 20px; width: 24px; height: 24px; color: #ff5050; opacity: 0.6; cursor: pointer;" onclick="CloseReviewDetail()"></i>
